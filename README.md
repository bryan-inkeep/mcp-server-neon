...
- **Node.js (>= v20.0.0):** Download from [nodejs.org](https://nodejs.org).
...
- **`list_shared_projects`**: Lists Neon projects shared with the current user. Supports a search parameter and limiting the number of projects returned (default: 25).
